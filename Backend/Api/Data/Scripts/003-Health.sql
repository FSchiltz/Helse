...
CREATE INDEX IF NOT EXISTS event_date_type_personid_idx
    ON health.Event USING btree    
    (personid ASC NULLS LAST)
    INCLUDE(type, Start, Stop)
    WITH (deduplicate_items=True);

CREATE INDEX IF NOT EXISTS Event_tag_personid_idx
    ON health.Event USING btree
...
ALTER TABLE health.Treatment
  ADD CONSTRAINT FK_Person_TO_Treatment
